function saveToLocalStorage(event) {
    ...
    axios.post("https://crudcrud.com/api/678e0ef798964d9a949c9cb1c1f79920/htt", obj)
    .then((response)=>{
...
window.addEventListener("DOMContentLoaded", () => {
    axios.get('https://crudcrud.com/api/678e0ef798964d9a949c9cb1c1f79920/htt')
    .then((response)=>{
        console.log(response)
...
function deleteUser(userid){
    axios.delete(`https://crudcrud.com/api/678e0ef798964d9a949c9cb1c1f79920/htt/${userid}`)
    .then((response)=>{
        console.log(response)
        removeUserFromScreen(userid);
    })
